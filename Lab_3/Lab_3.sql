...
CREATE INDEX idx_rating_coment
ON coment (rating);

CREATE INDEX idx_response_coment
ON coment (response);


-- -----------------------------------------------------
-- Table `mark_of_interview`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`mark_of_interview` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_mark_of_interview_coment1_idx` (`coment_id` ASC) VISIBLE,
  CONSTRAINT `fk_mark_of_interview_coment1`
...
CREATE INDEX idx_coment_id_mark_of_interview
ON mark_of_interview (coment_id);


-- -----------------------------------------------------
-- Table `potential_candidate`
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `vacancy_has_contact_person`
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `vacancy_has_potential_candidate`
-- -----------------------------------------------------
...
-- -----------------------------------------------------
INSERT INTO `mydb`.`mark_of_interview` (`id`, `level`, `coment_id`) VALUES ('1', 'excellent', '1');
INSERT INTO `mydb`.`mark_of_interview` (`id`, `level`, `coment_id`) VALUES ('2', 'excellent', '2');
INSERT INTO `mydb`.`mark_of_interview` (`id`, `level`, `coment_id`) VALUES ('3', 'satisfactory', '3');
INSERT INTO `mydb`.`mark_of_interview` (`id`, `level`, `coment_id`) VALUES ('4', 'good', '4');
INSERT INTO `mydb`.`mark_of_interview` (`id`, `level`, `coment_id`) VALUES ('5', 'excellent', '5');
INSERT INTO `mydb`.`mark_of_interview` (`id`, `level`, `coment_id`) VALUES ('6', 'good', '6');
INSERT INTO `mydb`.`mark_of_interview` (`id`, `level`, `coment_id`) VALUES ('7', 'excellent', '7');
INSERT INTO `mydb`.`mark_of_interview` (`id`, `level`, `coment_id`) VALUES ('8', 'satisfactory', '8');
INSERT INTO `mydb`.`mark_of_interview` (`id`, `level`, `coment_id`) VALUES ('9', 'good', '9');
INSERT INTO `mydb`.`mark_of_interview` (`id`, `level`, `coment_id`) VALUES ('10', 'excellent', '10');


-- -----------------------------------------------------
-- INSERT `coment`
-- -----------------------------------------------------
INSERT INTO `mydb`.`coment` (`id`, `rating`, `response`) VALUES ('1', '1', 'Upgrade knowledge in db');
INSERT INTO `mydb`.`coment` (`id`, `rating`, `response`) VALUES ('2', '2', 'Upgrade knowledge in OOP');
INSERT INTO `mydb`.`coment` (`id`, `rating`, `response`) VALUES ('3', '3', 'GOOD');
INSERT INTO `mydb`.`coment` (`id`, `rating`, `response`) VALUES ('4', '4', 'Upgrade knowledge in ds');
INSERT INTO `mydb`.`coment` (`id`, `rating`, `response`) VALUES ('5', '5', 'GOOD');
INSERT INTO `mydb`.`coment` (`id`, `rating`, `response`) VALUES ('6', '6', 'Upgrade knowledge in db');
INSERT INTO `mydb`.`coment` (`id`, `rating`, `response`) VALUES ('7', '7', 'Bad');
INSERT INTO `mydb`.`coment` (`id`, `rating`, `response`) VALUES ('8', '8', 'GOOD');
INSERT INTO `mydb`.`coment` (`id`, `rating`, `response`) VALUES ('9', '9', 'Upgrade knowledge in ds');
INSERT INTO `mydb`.`coment` (`id`, `rating`, `response`) VALUES ('10', '10', 'Bad');
